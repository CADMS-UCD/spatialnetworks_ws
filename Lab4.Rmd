...
# Creamos una variable para el año
net$year<-as.numeric(strftime(net$date,format = "%Y"))
# Creamos una variable para la semana del año
...
Como tenemos multiples años, tenemos que calcular la semana en numero desde que empieza nuestros datos hast que terminan. Para esto usaremos un offset que agregara 53 semanas o 106 dependiendo del año.    
...
Another way to visualize the network activity is showing at which time points each of the node was active. the unpper part of the plot represent the presence of the node in the network and the lower part represent the activity of the node in the network.  
