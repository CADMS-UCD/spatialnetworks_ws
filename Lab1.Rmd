...
We can use base R to make our figures, but since we will be focusing on ggplot2, we will use the library ggraph which has a very similar syntax to ggplot.  
