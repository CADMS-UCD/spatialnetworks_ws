...
|-----------|-------------------|---------------------------------|-----------------------------------------|
|6:00-6:30  |[Introduction to SNA](Part_I.html)|Visualization of spatial networks|Dynamic Networks and network based models|
|6:30-8:00  |[Lab 1](Lab1.html)              | Lab 2                           | Lab 3                                   |