...
Most of infectious disease are transmitted via direct contacts, therefore, animal trade and other contacts between animals play an escential role in the disease spread.  
Social network analysis (SNA) is a powerful tool to explore the interactions between agents in a contact network and obtain additional information regarding the structure and dynamic on a community. The agents or nodes could be defined as the farms that belng to a trade network, wildlife animals followed by gps collars, or animals observed in a group. Using these methodologies we can identify individuals that could have a bigger role in disease spread when a disease is introduced to the community.  

In this workshop we will use data regarding movement of production animals in a contact network to demonstrate the applications of spatio-temporal network analysis. These methodologies can be applied to other settings such as wildlife monitoring, exploring hierarchical relationships between animal groups, among others. The first part of the workshop will focus on the description of static networks and the second part will be using dynamic network analysis, which includes temporal dynamics of the movements. Both parts also will include the spatial component.  
